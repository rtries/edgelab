"use client";
/** Research Dashboard: the state of the research program at a glance.
 * Moved off "/" during the beginner-simplification pass — this is
 * advanced/quant content now reached via Research Lab, not the
 * beginner-facing Home page. */
